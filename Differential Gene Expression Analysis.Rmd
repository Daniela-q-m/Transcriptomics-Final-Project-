...
```{r}
#File path Daniela
files_D <- file.path('/Users/danielaquijano/Documents/Final_Project_Files',paste(sample_names,"ReadsPerGene.out.tab"))
```
...
i=1
for (file in files) {
  count_data[sample_names[i]]<-fread(file,sep="\t",select = c("V1", "V3"))
  i=i+1
}
```
