...
```{r}
#File path Daniela
files_D <- file.path('/Users/danielaquijano/Documents/GitHub/Transcriptomics-Final-Project/source_files/J_20_samples',paste(sample_names,"ReadsPerGene.out.tab",sep=""))
```
...
```
8870916 Reads 1 (forward) were mapped to known genes and  314680 Reads 2 (reverse) were mapped to known genes. 
