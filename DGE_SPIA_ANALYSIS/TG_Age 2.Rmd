...
PCA_Genotype<-plotPCA(vst_dds,intgroup=c("Age"))
...
```{r}
## Dotplot 
png("Dotplot rTg4510 Age.png", width = 12, height = 10 , units = 'in', res = 300)
dotplot(ego, showCategory=10)+theme(text = element_text(size = 16))+ggtitle('Enriched genes when comparing TG 2 & 8 month old mice')+ theme(plot.title = element_text(size=16))
...
png("cnetplot rTg4510 Age.png", width = 12, height = 10 , units = 'in', res = 300)
...
cnetplot(ego, 
         ...
         cex_label_gene = 0.75,
         shadowtext = "all")+ggtitle('Enriched pathways when comparing TG mice at ages 2 and 8 months')
