...
dotplot(ego, showCategory=30)+theme(text = element_text(size = 1)) +scale_y_discrete(labels=function(x) str_wrap(x, width=40))+ggtitle('Enriched genes when comparing rtg4510 and J20 mice')+ theme(plot.title = element_text(size=16))
```
...
cnetplot(ego, 
         ...
         cex_label_gene = 0.75,
         shadowtext = "all")+ggtitle('Enriched genes when comparing J20 and rtg4510 mice')
