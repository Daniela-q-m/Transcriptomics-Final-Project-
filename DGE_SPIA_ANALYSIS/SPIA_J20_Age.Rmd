...
## Dotplot 
dotplot(ego, showCategory=30)+theme(text = element_text(size = 1)) +scale_y_discrete(labels=function(x) str_wrap(x, width=40))+ggtitle('Enriched genes when comparing J20 mice at 6 and 12 months')+ theme(plot.title = element_text(size=16))
