...
```{r}
#Compare 2 vs 8
res_1 <- results(dds, contrast = c("Age", "6", "12"))
...
## Dotplot 
dotplot(ego, showCategory=20)+theme(text = element_text(size = 1)) +scale_y_discrete(labels=function(x) str_wrap(x, width=40))+ggtitle('Enriched genes when comparing J20 mice at 6 and 12 months')+ theme(plot.title = element_text(size=16))
